...
def banner():
    ...
    # Assuming B is for blue and br resets color
    # You can adjust these based on your actual color variables
    print(f"{B}╔══════════════════════════════════════════════════════════╗{br}")
    print(f"{B}║      ═══════════════════════════════════════════════════      ║{br}")
    print(f"{B}║                                                          ║{br}")
    print(f"{B}║      ██╗███╗   ██╗███████╗████████╗ █████╗               ║{br}")
    ...
    print()
    print(f"══════════════════════════════════════════════════════════")
    print(f"        INSTA REPORT - Instagram Mass Reporting Tool")
    print(f"        Version: 1.0 | Developer: @Prateek_Hacker { Telegram Username }"                )
    print(f"══════════════════════════════════════════════════════════")
    print()

# Then in your main code:
banner()  # Call this at the beginning

print(f'{B}[Send automatic reports to Instagram]{br}')
print('''
Coded By : PRATEEK GURJAR
